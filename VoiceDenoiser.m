classdef VoiceDenoiser < audioPlugin
    ...
    properties (Constant)
        ...
        PluginInterface = audioPluginInterface(...
            ...
            'VendorVersion', '1.0.0',...
            'UniqueId', 'AAS3',...
            'BackgroundImage', 'assets/scrap.jpeg',...
             audioPluginGridLayout(...
                'RowHeight', [1 64 64 32 32 32 64 32 64 32 64 1],...
                'ColumnWidth', [1 60 30 60 30 60 30 60 30 60 1]), ...
            audioPluginParameter('Bypass', 'DisplayName', 'Bypass',... 
                'Mapping', {'enum', 'Off', 'On'}, ...
                'Style', 'vtoggle', ...
                'Filmstrip', 'assets/onoff.png',...
                'FilmstripFrameSize', [50 30], ...
                'Layout', [2,2]),...
            audioPluginParameter('NoiseProfile', 'DisplayName', 'Noise Profile', ...
                'Mapping', {'enum', 'Washing Machine', 'White Noise', 'Crowd Noise'}, ...
                'Layout', [2,3]), ...
            audioPluginParameter('Strength', 'DisplayName', 'Strength', ...
                'Mapping', {'lin', 0, 1}, ...
                'Style', 'rotaryknob', ...
                'Filmstrip', 'assets/slider.png',...
                'FilmstripFrameSize', [128 32], ...
                'Layout', [2,4]),...
            'InputChannels',1,...
            'OutputChannels',1,...
            'PluginName','VoiceDenoiser')
